...
public class BluetoothMessageService {
    ...
    private static final UUID MY_UUID = UUID.fromString("00003101-0000-1000-8000-00805f9b34fb");
...
//    private int mConnectionLostCount;
    ...
    // Constants that indicate Message to computer
    ...
    public synchronized void connect(BluetoothDevice device) {
        ...
        if(TA){
    		...
    		System.out.println("Connecting tag set at:"+ System.currentTimeMillis());
    	} 
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        if(TA){
    		...
    		System.out.println("Connectted properly:"+ System.currentTimeMillis());
    	} 
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                //tmp = (BluetoothSocket) m.invoke(device, 19);
            } 
        ...
        public void run() { 
            ...
            try {
            	...
            	if(TA){
            		...
            		System.out.println("Connect started at:"+ System.currentTimeMillis());
            	} 
                mmSocket.connect();
            } catch (IOException e) {
                connectionFailed();
            ...
            if(TA){
        		...
        		System.out.println("Connect finished at:"+ System.currentTimeMillis());
        	} 
